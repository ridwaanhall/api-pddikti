...
@router.get("/prodi-bidang-ilmu/agama/", summary="Get study programs in religion field")
def prodi_bidang_ilmu_agama():
    return as_json(api_client.get("prodi/bidang-ilmu/Agama"))


@router.get("/prodi-bidang-ilmu/ekonomi/", summary="Get study programs in economics field")
def prodi_bidang_ilmu_ekonomi():
    return as_json(api_client.get("prodi/bidang-ilmu/Ekonomi"))


@router.get("/prodi-bidang-ilmu/humaniora/", summary="Get study programs in humanities field")
def prodi_bidang_ilmu_humaniora():
    return as_json(api_client.get("prodi/bidang-ilmu/Humaniora"))


@router.get("/prodi-bidang-ilmu/kesehatan/", summary="Get study programs in health field")
def prodi_bidang_ilmu_kesehatan():
    return as_json(api_client.get("prodi/bidang-ilmu/Kesehatan"))


@router.get("/prodi-bidang-ilmu/mipa/", summary="Get study programs in science field")
def prodi_bidang_ilmu_mipa():
    return as_json(api_client.get("prodi/bidang-ilmu/MIPA"))


@router.get("/prodi-bidang-ilmu/pendidikan/", summary="Get study programs in education field")
def prodi_bidang_ilmu_pendidikan():
    return as_json(api_client.get("prodi/bidang-ilmu/Pendidikan"))


@router.get("/prodi-bidang-ilmu/pertanian/", summary="Get study programs in agriculture field")
def prodi_bidang_ilmu_pertanian():
    return as_json(api_client.get("prodi/bidang-ilmu/Pertanian"))


@router.get("/prodi-bidang-ilmu/seni/", summary="Get study programs in arts field")
def prodi_bidang_ilmu_seni():
    return as_json(api_client.get("prodi/bidang-ilmu/Seni"))


@router.get("/prodi-bidang-ilmu/sosial/", summary="Get study programs in social field")
def prodi_bidang_ilmu_sosial():
    return as_json(api_client.get("prodi/bidang-ilmu/Sosial"))


@router.get("/prodi-bidang-ilmu/teknik/", summary="Get study programs in engineering field")
